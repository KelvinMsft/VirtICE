...
#define DBG_VMENTRY_PRE_VMCS_LOAD_GUEST_STATE		0x00000010
#define DBG_VMENTRY_POST_VMCS_LOAD_GUEST_STATE		0x00000020 

#define DBG_VMENTRY_PRE_VMCS_SAVE_HOST_STATE		0x00000040
#define DBG_VMENTRY_POST_VMCS_SAVE_HOST_STATE		0x00000080

#define DBG_VMEXIT_PRE_VMCS_SAVE_GUEST_STATE		0x00000100
#define DBG_VMEXIT_POST_VMCS_SAVE_GUEST_STATE		0x00000200 



#define DBG_VMEXIT_ALL							  DBG_VMEXIT_PRE_VMCS_LOADING | DBG_VMEXIT_POST_VMCS_LOADING | \
										  DBG_VMEXIT_PRE_VMCS_LOAD_HOST_STATE | DBG_VMEXIT_POST_VMCS_LOAD_HOST_STATE | \
										 DBG_VMENTRY_PRE_VMCS_LOAD_GUEST_STATE| DBG_VMENTRY_POST_VMCS_LOAD_GUEST_STATE  | \
										  DBG_VMENTRY_PRE_VMCS_SAVE_HOST_STATE| DBG_VMENTRY_POST_VMCS_SAVE_HOST_STATE  | \
										 DBG_VMEXIT_PRE_VMCS_SAVE_GUEST_STATE |	DBG_VMEXIT_POST_VMCS_SAVE_GUEST_STATE 
